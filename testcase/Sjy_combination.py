...
class CombinationTest(unittest.TestCase):
    ...
    def test_textAndimg(self):
        ...
        public_addTool(self.comb_PO, self.comb_PO.tool_text_loc, self.comb_PO.el_textNote_loc)
        self.comb_PO.input_textNote(self.textContent)
        public_addTool(self.comb_PO, self.comb_PO.tool_img_loc, self.comb_PO.el_imgDIV_loc, x=200, y=300)
        WSupload_img(self.comb_PO, self.comb_PO.el_imgDIV_loc, 'data-id')
        self.comb_PO.driver.refresh()
        #是否新建成功
        ...
        rightClick_action(self.comb_PO, el=self.comb_PO.el_imgDIV_loc, actionEl=self.comb_PO.btn_jianqie_loc)
        ...
        rightClick_action(self.comb_PO, 200, 10, self.comb_PO.tool_loc, actionEl=self.comb_PO.btn_zhantie_loc)
        #检查是否粘贴成功
        self.assertTrue(public_check(self.comb_PO, self.comb_PO.el_img_loc, attr='src'))
        self.assertTrue(public_check(self.comb_PO, self.comb_PO.el_textNote_loc))
        #框选，右键复制，粘贴
        selection(self.comb_PO, [self.comb_PO.el_textNote_loc, self.comb_PO.el_imgDIV_loc])
        rightClick_action(self.comb_PO, el=self.comb_PO.el_imgDIV_loc, actionEl=self.comb_PO.btn_copy_loc)
        left_click(self.comb_PO, 50, -80, self.comb_PO.tool_mouse_loc)
        self.assertIs(public_check(self.comb_PO, self.comb_PO.el_divs_loc, islen=True), 4)
        rightClick_action(self.comb_PO, 200, 400, self.comb_PO.tool_loc, actionEl=self.comb_PO.btn_zhantie_loc)
        #检查是否粘贴成功
        self.assertTrue(public_check(self.comb_PO, self.comb_PO.el_img_loc, attr='src'))
    ...
    def test_textAndfolder(self):
        ...
        public_addTool(self.comb_PO, self.comb_PO.tool_text_loc, self.comb_PO.el_textNote_loc)
        self.comb_PO.input_textNote(self.textContent)
        public_addTool(self.comb_PO, self.comb_PO.tool_folder_loc, self.comb_PO.el_folder_loc, x=200, y=300)
        #是否新建成功
        ...
        rightClick_action(self.comb_PO, el=self.comb_PO.el_folder_loc, actionEl=self.comb_PO.btn_fjianqie_loc)
        left_click(self.comb_PO, 50, -80, self.comb_PO.tool_mouse_loc)
        self.assertIs(public_check(self.comb_PO, self.comb_PO.el_divs_loc, islen=True), 2)
        rightClick_action(self.comb_PO, 200, 10, self.comb_PO.tool_loc, actionEl=self.comb_PO.btn_zhantie_loc)
        #检查是否粘贴成功
    ...
    def test_imgAndfolder(self):
        ...
        public_init(self.comb_PO, self.username, self.password, self.projectName)
        public_addTool(self.comb_PO, self.comb_PO.tool_img_loc, self.comb_PO.el_imgDIV_loc)
        WSupload_img(self.comb_PO, self.comb_PO.el_imgDIV_loc, 'data-id')
        public_addTool(self.comb_PO, self.comb_PO.tool_folder_loc, self.comb_PO.el_folder_loc, x=200, y=300)
        self.comb_PO.driver.refresh()
        #是否新建成功
