...
class ImgNoteTest(unittest.TestCase):
    ...
    def test_add_imgNote(self):
        ...
        rightClick(self.img_PO, el=self.img_PO.el_imgDIV_loc, actionEl=self.img_PO.btn_imgDel_loc)
        #是否删除成功
    ...
    def test_replace(self):
        ...
        #右键-替换
        rightClick(self.img_PO, el=self.img_PO.el_imgDIV_loc, actionEl=self.img_PO.btn_imgReplace_loc)
    ...
    def test_shear(self):
        ...
        public_init(self.img_PO, self.username, self.password, self.projectName)
        public_add(self.img_PO, [('i', 1)])
        rightClick(self.img_PO, el=self.img_PO.el_imgDIV_loc, actionEl=self.img_PO.btn_imgCut_loc)
        #检查剪切是否成功
        self.assertFalse(public_check(self.img_PO, self.img_PO.el_imgDIV_loc))
        ...
        rightClick(self.img_PO, actionEl=self.img_PO.btn_Paste_loc)
        self.assertTrue(public_check(self.img_PO, self.img_PO.el_imgDIV_loc))
    ...
    def test_doubleImgCopy(self):
        ...
        selection(self.img_PO, self.img_PO.el_imgDIV_loc)
        #右键-复制
        rightClick(self.img_PO, el=self.img_PO.el_imgDIV_loc, actionEl=self.img_PO.btn_imgCopy_loc)
        #右键-粘贴
