...
from pages.Page_file import FilePage
...
class FileTest(unittest.TestCase):
    ...
    def test_prePage(self):
        ...
        self.file_PO.click(self.file_PO.btn_fileclose_loc)  #关闭预览
        self.file_PO.driver.refresh()
        sleep(3)
